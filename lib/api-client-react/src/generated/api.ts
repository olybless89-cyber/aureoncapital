...
export const getCreateCopyTradeUrl = () => {
  ...
  return `/api/admin/copy-trade`
}

/**
 * @summary Admin mirrors a simulated trade into one or more user accounts
 */
export const createCopyTrade = async (copyTradeRequest: CopyTradeRequest, options?: RequestInit): Promise<CopyTradeResponse> => {

  return customFetch<CopyTradeResponse>(getCreateCopyTradeUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(copyTradeRequest)
  }
);}
...
export const getCreateCopyTradeMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createCopyTrade>>, TError,{data: BodyType<CopyTradeRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createCopyTrade>>, TError,{data: BodyType<CopyTradeRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createCopyTrade>>, {data: BodyType<CopyTradeRequest>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateCopyTradeMutationBody = BodyType<CopyTradeRequest>
    export type CreateCopyTradeMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Admin mirrors a simulated trade into one or more user accounts
 */
export const useCreateCopyTrade = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createCopyTrade>>, TError,{data: BodyType<CopyTradeRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createCopyTrade>>,
        TError,
        {data: BodyType<CopyTradeRequest>},
        TContext
      > => {
